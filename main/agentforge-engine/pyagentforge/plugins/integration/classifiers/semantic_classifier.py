...
from pyagentforge.plugins.integration.category_system.category import Category
from pyagentforge.plugins.integration.category_system.category_registry import ClassificationResult
...
class SemanticClassifier:
    ...
    def update_categories(self, categories: list[Category]) -> None:
        ...
        logger.info("Updated categories, cleared embedding cache")
