...
- [功能模块](#功能模块)
  ...
  - [12. API Gateway - Moved to Service](#12-api-gateway---moved-to-service)
- [使用场景](#使用场景)
- [配置说明](#配置说明)
- [进阶文档](#进阶文档)
...
### 12. API Gateway - Moved to Service

PyAgentForge no longer hosts REST API or WebSocket endpoints directly.
All gateway endpoints are now hosted by `main/Service`.
...
#### Legacy-compatible endpoints (served by Service)
...
| `/api/agents` | GET/POST | List or create agent |
| `/ws/{session_id}` | WS | Stream chat events |
